            ...
            <div class="col-md-8 col-lg-6">
                <div class="welcome-card">
                    <div class="brand-section">
                        ...
                        <p>Streamline your business operations with our powerful POS solution</p>
                    </div>
                    <div class="action-section">
                        <h3 class="mb-4">Welcome to PointShift</h3>
                        <p class="text-muted mb-4">Please sign in to access your dashboard or create a new account to get started.</p>
